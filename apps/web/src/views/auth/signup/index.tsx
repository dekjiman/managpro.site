...
export default function SignUpPage() {
  ...
  if (isSignUpDisabled && !isInviteFlow) {
    return (
      <>
      <PageHead title={t`Daftar | managPro`} />
          ...
          <div className="justify-top flex h-full flex-col items-center px-4 sm:justify-center">
            <div className="z-10 flex w-full flex-col items-center">
              ...
              <p className="mb-10 text-3xl font-bold tracking-tight text-light-1000 dark:text-dark-1000">
                {t`Pendaftaran dinonaktifkan`}
              </p>
              <p className="text-md text-center text-light-1000 dark:text-dark-1000">
                {t`Pendaftaran saat ini dinonaktifkan. Silakan coba lagi nanti.`}
              </p>
            </div>
            <PatternedBackground />
          </div>
  ...
  return (
    <>
      <PageHead title={t`Sign up | managPro`} />
      <main className="h-screen bg-light-100 pt-20 dark:bg-dark-50 sm:pt-0">
        <div className="justify-top flex h-full flex-col items-center px-4 sm:justify-center">
          <div className="z-10 flex w-full flex-col items-center">
            <Link href="/">
            ...
            <p className="mb-10 text-3xl font-bold tracking-tight text-light-1000 dark:text-dark-1000">
              {isMagicLinkSent ? t`Periksa inbox Anda` : t`Mulai sekarang`}
            </p>
            {isMagicLinkSent ? (
