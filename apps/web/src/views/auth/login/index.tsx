...
export default function LoginPage() {
  ...
  return (
    <>
      <PageHead title={t`Masuk | managPro`} />
        ...
        <div className="justify-top flex h-full flex-col items-center px-4 sm:justify-center">
          <div className="z-10 flex w-full flex-col items-center">
            ...
            <p className="mb-10 text-3xl font-bold tracking-tight text-light-1000 dark:text-dark-1000">
              {isMagicLinkSent ? t`Periksa inbox Anda` : t`Selamat datang kembali`}
            </p>
            {isMagicLinkSent ? (
              <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <p className="text-md mt-2 text-center text-light-1000 dark:text-dark-1000">
                  <Trans>
                    Klik tautan yang kami kirim ke {magicLinkRecipient} untuk masuk.
                  </Trans>
                </p>
              </div>
            ) : (
