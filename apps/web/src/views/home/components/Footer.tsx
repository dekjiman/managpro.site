...
const Footer = () => {
  const navigation = {
    documentation: [
      { name: t`Memulai`, href: "https://docs.managpro.site/introduction" },
      {
        name: t`Mengimpor dari Trello`,
        href: "https://docs.managpro.site/imports/trello",
      },
      {
        name: t`Referensi API`,
        href: "https://docs.managpro.site/api-reference/introduction",
      },
    ],
    company: [
      { name: t`Peta Jalan`, href: "/managepro.site/roadmap" },
      { name: t`Kontak`, href: "mailto:support@managpro.site" },
      { name: t`Teman OSS`, href: "/oss-friends" },
    ],
    legal: [
      { name: t`Syarat Layanan`, href: "/terms" },
      { name: t`Kebijakan Privasi`, href: "/privacy" },
    ],
    resources: [
      { name: t`Fitur`, href: "/#features" },
      { name: t`Harga`, href: "/#pricing" },
      { name: t`FAQ`, href: "/#faq" },
    ],
  };
