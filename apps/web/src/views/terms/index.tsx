...
export default function TermsView() {
  ...
  const DOMAIN = process.env.NEXT_PUBLIC_BASE_URL ?? "https://kan.bn";
  const PRIVACY_URL = `${DOMAIN}/privacy`;
  const CONTACT_EMAIL = "support@managpro.local";

  return (
    <Layout>
      <PageHead title="Terms of Service | managPro" />
          ...
          <div className="mb-6">
            ...
            <Text>
              ...
              <Link
                ...
                href="mailto:support@managpro.local"
              >
                support@managpro.local
              </Link>
            </Text>
          </div>
        </div>
